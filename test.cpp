...
//	memView(0, 50);
//
//	//cout << "\ncharPtr Value :" << setw(11) << *charPtr << " address:" << (long*)charPtr << endl;
...
//
//	//cout << "Deallacting shortPtr:";
//	//deallocate(shortPtr);
//
//	//cout << "Deallacting charPtr:";
//	//deallocate(charPtr);
//	
//	cout << "Deallacting intptr:";
//	deallocate(intPtr);
//
//	cout << "Deallacting name:";
//	deallocate(name);
//
//
...
//	//cout << "inUse memory = " << inUseMemory() << endl;
//	//cout << "used memory = " << usedMemory() << endl;
//	//cout << "Total memory = " << inUseMemory() + usedMemory() + freeMemory() << endl;
//
//	system("PAUSE");
//
//
